...
@app.command()
def download(
    csv_url: str = typer.Option(
        BooksConfig.CSV_URL.value, help="URL to books CSV file"
    ),
    data_dir: str = typer.Option(
        BooksConfig.DATA_DIR.value, help="Directory to save CSV"
    ),
    books_dir: str = typer.Option(
        BooksConfig.BOOKS_DIR.value, help="Directory to save books"
    ),
):
